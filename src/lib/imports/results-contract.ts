...
export const RESULTS_MOLECULAR_FIELDS = [
  ...
  field("originalLatitude", "Latitude original", "coordinate", "graus decimais", "conditional", "-90 a 90; par completo; se inválido, só é descartado quando o par efetivo é completo e válido", "coordenada informada em campo; nunca inferida ou corrigida"),
  field("originalLongitude", "Longitude original", "coordinate", "graus decimais", "conditional", "-180 a 180; par completo; se inválido, só é descartado quando o par efetivo é completo e válido", "coordenada informada em campo; nunca inferida ou corrigida"),
